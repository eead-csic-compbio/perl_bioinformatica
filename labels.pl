...
$key = q/cite_Gutierrez-Rios2004/;
$external_labels{$key} = "$URL/" . q|node102.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_Berman2000/;
$external_labels{$key} = "$URL/" . q|node100.html|; 
$noresave{$key} = "$nosave";
...
$key = q/pasoref/;
$external_latex_labels{$key} = q|3.1.3|; 
$noresave{$key} = "$nosave";
...
$key = q/aritfunc/;
$external_latex_labels{$key} = q|2.7.4|; 
$noresave{$key} = "$nosave";
...
$key = q/problEvalAlin/;
$external_latex_labels{$key} = q|2.7.5|; 
$noresave{$key} = "$nosave";
...
$key = q/funcArreglos/;
$external_latex_labels{$key} = q|2.7.1|; 
$noresave{$key} = "$nosave";

$key = q/ventajSub/;
$external_latex_labels{$key} = q|3.1.5|; 
$noresave{$key} = "$nosave";
...
$key = q/problBLAST/;
$external_latex_labels{$key} = q|2.8.3|; 
$noresave{$key} = "$nosave";
...
$key = q/problEnzRest/;
$external_latex_labels{$key} = q|2.6.1|; 
$noresave{$key} = "$nosave";
