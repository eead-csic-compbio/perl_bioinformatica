...
\usepackage{times}\usepackage{html}
\usepackage{graphicx} 
\usepackage{float}
\usepackage{mathptmx}
\usepackage{amsmath}
...
\title{Perl5 en bioinform\'{a}tica\\}
\author{\copyright Bruno Contreras-Moreira\\
\htmladdnormallink{http://www.eead.csic.es/compbio}{http://www.eead.csic.es/compbio}\\
\htmladdnormallink{Fundaci\'{o}n ARAID}{http://www.araid.es} y
\htmladdnormallink{Estaci\'{o}n Experimental de Aula Dei}{http://www.eead.csic.es}-\htmladdnormallink{CSIC}{http://www.csic.es}, Zaragoza, Espa\~
{n}a\\
}
...
\stepcounter{section}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap4578}%
